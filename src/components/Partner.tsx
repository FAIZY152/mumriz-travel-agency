      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-foreground">
            AL-SUDAIS TRAVELS & TOURS
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Partner with us for all your air ticket needs. From international
            flights to domestic travel, we ensure the best rates and seamless
            booking experience.
          </p>
        </div>
          ...
          <div>
            <div className="mb-8">
              ...
              <p className="text-lg text-muted-foreground mb-6">
                Through our partnership with Alsudais Travel, we provide
                comprehensive flight booking services with competitive rates and
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
              <div className="bg-white rounded-lg p-6 shadow-sm border">
                ...
                <p className="text-sm text-muted-foreground">
                  Worldwide destinations with major airlines
                </p>
              </div>
              <div className="bg-white rounded-lg p-6 shadow-sm border">
                <Plane className="w-8 h-8 text-amber-600 mb-3" />
                ...
                <p className="text-sm text-muted-foreground">
                  All Saudi Arabian domestic routes
                </p>
              </div>
            </div>
